...
def createScene(rootNode):
		...
		#cubito1
                ...
                boxROIStiffness = cubito.addObject('BoxROI', name='boxROIStiffness', box=[-13, 38, -13,  13, 41, 13], drawBoxes=True, position="@tetras.rest_position", tetrahedra="@container.tetrahedra")
...
#################cubito/fibers
       ...
       #
		...
		#cubito/cavity
                ...
                cavity.addObject('MeshSTLLoader', name='loader', filename='CubitoRotadorx2_Cavity.stl')
