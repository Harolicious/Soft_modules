...
class Controller(Sofa.Core.Controller):
    def __init__(self, *args, **kwargs):
        ...
        # YM(p) = A*exp(-k*p) + C
        # (A=26587.0, k=0.10842, C=8079.4, R²=0.9926) 
        
        self.pressure_ranges = [0, 1.25, 2.5, 3.75, 5, 6.25, 7.5, 8.75, 10, 11.25, 12.5,
        ...
        self.YM_values = [32950, 29800, 27050, 24650, 22550, 20700, 19100, 17700, 16500,
                           15400, 14500, 13650, 12950, 12350, 11800, 11350, 10900, 10550,
                           10250, 9950, 9750, 9500, 9350, 9200, 9050, 8900, 8800, 8700,
                           8650, 8550, 8500, 8450, 8400, 8350, 8350, 8300, 8250, 8250,
                           8200, 8200]
        
        self.SPA_maxPressure_values = [1.25, 2.5, 3.75, 5, 6.25, 7.5, 8.75, 10, 11.25, 12.5,
                                        13.75, 15, 16.25, 17.5, 18.75, 20, 21.25, 22.5, 23.75,
                                        25, 26.25, 27.5, 28.75, 30, 31.25, 32.5, 33.75, 35,
                                        36.25, 37.5, 38.75, 40, 41.25, 42.5, 43.75, 45, 46.25,
                                        47.5, 48.75, 50]

        self.SPA.maxPressure.value = np.float64(self.SPA_maxPressure_values[-1])

        self.csv_file_path = "end_effector_data_Estirar_inverso_lista_40.csv"
