...
def createScene(rootNode):
        ...
        #cubito
                ...
                cubito.addObject('TetrahedronFEMForceField', template='Vec3', name='FEM', method='large', poissonRatio=0.4,  youngModulus=YMArray.flatten().tolist())
                ...
                modelSubTopo1.addObject('TetrahedronFEMForceField', template='Vec3', poissonRatio=0.4, youngModulus=20000)
                modelSubTopo1.addObject('YoungModulusActuator', template='Vec3', name='actuator', maxYoungVariationRatio=0.1, minYoung=10)
