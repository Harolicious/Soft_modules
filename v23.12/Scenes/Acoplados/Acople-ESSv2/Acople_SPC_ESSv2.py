...
class Controller(Sofa.Core.Controller):   
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.phase = 1   # Fase actual (1,2,3)
    ...
    def create_csv(self):
        self.csv_file_path = f"end_effector_phase_{self.phase}.csv"
    ...
    def apply_active_pressures(self):

        if self.phase == 1:       # SPC1 + SPC2
            self.SPC1.value.value = [self.Pressure1]
            self.SPC2.value.value = [self.Pressure2]
            self.SPC3.value.value = [0]

        elif self.phase == 2:     # SPC2 + SPC3
            self.SPC1.value.value = [0]
            self.SPC2.value.value = [self.Pressure2]
            self.SPC3.value.value = [self.Pressure3]

        elif self.phase == 3:     # SPC3 + SPC1
            self.SPC1.value.value = [self.Pressure1]
            self.SPC2.value.value = [0]
            self.SPC3.value.value = [self.Pressure3]
    ...
    def onAnimateBeginEvent(self, eventType):
        ...
        if not self.Decreasing:
            ...
            if (self.Pressure1 >= self.Maxpressure1 or
                self.Pressure2 >= self.Maxpressure2 or
            ...
            if (self.Pressure1 <= 0 and
                ...
                if self.phase > 3:
                    ...
                    print(f"Cambiando a fase {self.phase}")
                    self.Decreasing = False
                    self.Pressure1 = 0
                    self.Pressure2 = 0
                    self.Pressure3 = 0
...
def createScene(rootNode):
		...
		#cubito1
                ...
                boxROIStiffness1 = cubito.addObject('BoxROI', name='boxROIStiffness1', box=[-13, 37, -13,  13, 41, 13], drawBoxes=True, position="@tetras.rest_position", tetrahedra="@container.tetrahedra")
